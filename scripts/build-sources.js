...
function main() {
  ...
  const publicTopics = topics.map(({ id, label, icon, knownLimitation, description, sourceLabel }) => ({ id, label, icon, knownLimitation: knownLimitation || null, description: description || null, sourceLabel: sourceLabel || null }));
